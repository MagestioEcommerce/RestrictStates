<?php
namespace Magestio\RestrictStates\Plugin\StateFilter;
...
class StateFilter
{
    ...
    {
        $allowedStates = $this->scopeConfig->getValue('checkout/options/state_filter', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
